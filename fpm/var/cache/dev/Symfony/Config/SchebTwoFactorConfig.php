...
class SchebTwoFactorConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @template TValue
     * @param TValue $value
     * @default {"enabled":false,"mailer":null,"code_generator":"scheb_two_factor.security.email.default_code_generator","form_renderer":null,"sender_email":null,"sender_name":null,"template":"@SchebTwoFactor\/Authentication\/form.html.twig","digits":4}
     * @return \Symfony\Config\SchebTwoFactor\EmailConfig|$this
     * @psalm-return (TValue is array ? \Symfony\Config\SchebTwoFactor\EmailConfig : static)
     */
    public function email(array $value = []): \Symfony\Config\SchebTwoFactor\EmailConfig|static
    {
        if (!\is_array($value)) {
