...
class getSchebTwoFactor_Security_Email_DefaultFormRendererService extends App_KernelDevDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->privates['scheb_two_factor.security.email.default_form_renderer'] = $container->createProxy('DefaultTwoFactorFormRendererGhost3f31ba7', static fn () => \DefaultTwoFactorFormRendererGhost3f31ba7::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
