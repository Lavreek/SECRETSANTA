...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\InviteController' => 'getInviteControllerService',
            'App\\Controller\\PreviewController' => 'getPreviewControllerService',
            'App\\Twig\\Runtime\\AuthRuntime' => 'getAuthRuntimeService',
            'App\\Twig\\Runtime\\GameRuntime' => 'getGameRuntimeService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/Extension/AuthExtension.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/Extension/GameExtension.php';
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\ShuffleRepository' => ['privates', 'App\\Repository\\ShuffleRepository', 'getShuffleRepositoryService', true],
            ...
            'App\\Repository\\ShuffleRepository' => '?',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AuthController', 'App\\Controller\\GameController', 'App\\Controller\\InviteController', 'App\\Controller\\PreviewController', 'App\\Twig\\Runtime\\AuthRuntime', 'App\\Twig\\Runtime\\GameRuntime', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    {
        return $container->privates['asset_mapper.repository'] = new \Symfony\Component\AssetMapper\AssetMapperRepository([(\dirname(__DIR__, 4).'/vendor/symfony/ux-turbo/src/DependencyInjection/../../assets/dist') => '@symfony/ux-turbo', (\dirname(__DIR__, 4).'/vendor/symfony/stimulus-bundle/src/DependencyInjection/../../assets/dist') => '@symfony/stimulus-bundle', 'assets/' => ''], \dirname(__DIR__, 4), ['#^(?=[^\\.]).*\\.d\\.ts$#', '#^(?=[^\\.]).*.*/(?=[^\\.])controllers\\.json$#', '#^(?=[^\\.]).*/(?=[^\\.])assets/(?=[^\\.])styles/(?=[^\\.])_.*\\.scss$#', '#^(?=[^\\.]).*/(?=[^\\.])assets/(?=[^\\.])styles/(?=[^\\.]).*.*/(?=[^\\.])_.*\\.scss$#'], true, true);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $instance->addExtension(new \App\Twig\Extension\AuthExtension());
        $instance->addExtension(new \App\Twig\Extension\GameExtension());
        ...
        $instance->addRuntimeLoader(new \Twig\RuntimeLoader\ContainerRuntimeLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Twig\\Runtime\\AuthRuntime' => ['services', 'App\\Twig\\Runtime\\AuthRuntime', 'getAuthRuntimeService', true],
            'App\\Twig\\Runtime\\GameRuntime' => ['services', 'App\\Twig\\Runtime\\GameRuntime', 'getGameRuntimeService', true],
            ...
            'App\\Twig\\Runtime\\AuthRuntime' => '?',
            'App\\Twig\\Runtime\\GameRuntime' => '?',
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'scheb_two_factor.email.sender_email' => 'noreply@yourdwell.ru',
            'scheb_two_factor.email.sender_name' => 'Secret Santa',
